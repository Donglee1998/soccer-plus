                        ...
                        <div class="blockMapStats__goal shootRate__level">
                            <div class="layoutLeft">
                                <div class="layoutItem__zone layout-item__lef">
                                    <div class="goalNumbers__item {{ $data_004['goal_number_analysis_guest'][16]['color'] }}" style="background-color: rgb(204, 204, 204);">
                                        <div class="goalRatio">{{ $data_004['goal_number_analysis_guest'][16]['probability'] }}<span class="goal-value">%</span></div>
                                        <div class="goalValue font-barlow-semi">({{ $data_004['goal_number_analysis_guest'][16]['counter_value_guest'] }}/ {{ $data_004['goal_number_analysis_guest'][16]['counter_total_guest'] }})</div>
                                    </div>
                                </div>
                            </div>
                            <div class="layoutTop">
                                <div class="layoutItem__zone layoutItem__lef">
                                    <div class="goalNumbers__item {{ $data_004['goal_number_analysis_guest'][17]['color'] }}" style="background-color: rgb(204, 204, 204);">
                                        <div class="goalRatio">{{ $data_004['goal_number_analysis_guest'][17]['probability'] }}<span class="goal-value">%</span></div>
                                        <div class="goalValue font-barlow-semi">({{ $data_004['goal_number_analysis_guest'][17]['counter_value_guest'] }}/ {{ $data_004['goal_number_analysis_guest'][17]['counter_total_guest'] }})</div>
                                    </div>
                                </div>
                                <div class="layoutItem__zone layoutItem__right">
                                    <div class="goalNumbers__item {{ $data_004['goal_number_analysis_guest'][18]['color'] }}" style="background-color: rgb(204, 204, 204);">
                                        <div class="goalRatio">{{ $data_004['goal_number_analysis_guest'][18]['probability'] }}<span class="goal-value">%</span></div>
                                        <div class="goalValue font-barlow-semi">({{ $data_004['goal_number_analysis_guest'][18]['counter_value_guest'] }}/ {{ $data_004['goal_number_analysis_guest'][18]['counter_total_guest'] }})</div>
                                    </div>
                                </div>
                            </div>
                            <div class="layoutRight">
                                <div class="layoutItem__zone layout-item__bottom">
                                    <div class="goalNumbers__item {{ $data_004['goal_number_analysis_guest'][19]['color'] }}" style="background-color: rgb(204, 204, 204);">
                                        <div class="goalRatio">{{ $data_004['goal_number_analysis_guest'][19]['probability'] }}<span class="goal-value">%</span></div>
                                        <div class="goalValue font-barlow-semi">({{ $data_004['goal_number_analysis_guest'][19]['counter_value_guest'] }}/ {{ $data_004['goal_number_analysis_guest'][19]['counter_total_guest'] }})</div>
                                    </div>
                                </div>
                            </div>
                            <div class="layoutMiddle">
                                <div class="goalNumbers">
                                    <div class="goalNumbers__wrap">
                                        @for($i = 1; $i <= 15; $i++)
                                        <div class="goalNumbers__item {{ $data_004['goal_number_analysis_guest'][$i]['color'] }}">
                                            <div class="goalRatio">
                                                {{ $data_004['goal_number_analysis_guest'][$i]['probability'] }} <span class="goalValue">%</span>
                                            </div>
                                            <div class="goalValue">({{ $data_004['goal_number_analysis_guest'][$i]['counter_value_guest'] }}/ {{ $data_004['goal_number_analysis_guest'][$i]['counter_total_guest'] }})</div>
                                        </div>
                                        @endfor
                                    </div>
                                </div>
                            ...
                            <div class="layoutLeft">
                                <div class="layoutItem__zone layout-item__lef">
                                    <div class="goalNumbers__item handledScore itemL">
                                        @if($data_004['goal_coordinate_analysis_guest'][16] ?? null)
                                            @foreach($data_004['goal_coordinate_analysis_guest'][16] as $key => $value)
                            ...
                            <div class="layoutTop">
                                <div class="layoutItem__zone layoutItem__lef">
                                    <div class="goalNumbers__item handledScore itemBot">
                                        @if($data_004['goal_coordinate_analysis_guest'][17] ?? null)
                                            @foreach($data_004['goal_coordinate_analysis_guest'][17] as $key => $value)
                                            <p class="coordinate" style="top: {{$value['coord_y']}}%;left: {{$value['coord_x']}}%;transform: translate(-50%, -60%)"><img src="/assets/img/svg/ic_cross.svg" alt=""></p>
                                            @endforeach
                                        @endif
                                    </div>
                                ...
                                <div class="layoutItem__zone layoutItem__right">
                                    <div class="goalNumbers__item handledScore itemBot last">
                                        @if($data_004['goal_coordinate_analysis_guest'][18] ?? null)
                                            @foreach($data_004['goal_coordinate_analysis_guest'][18] as $key => $value)
                                            <p class="coordinate" style="top: {{$value['coord_y']}}%;left: {{$value['coord_x']}}%;transform: translate(-50%, -60%)"><img src="/assets/img/svg/ic_cross.svg" alt=""></p>
                                            @endforeach
                                        @endif
                                    </div>
                            ...
                            <div class="layoutRight">
                                <div class="layoutItem__zone layout-item__lef">
                                    <div class="goalNumbers__item handledScore itemR">
                                        @if($data_004['goal_coordinate_analysis_guest'][19] ?? null)
                                            @foreach($data_004['goal_coordinate_analysis_guest'][19] as $key => $value)
                                            <p class="coordinate" style="top: {{$value['coord_y']}}%;left: {{$value['coord_x']}}%;transform: translate(-50%, -60%)"><img src="/assets/img/svg/ic_cross.svg" alt=""></p>
                                            @endforeach
                                        @endif
                                    </div>
                                ...
                                <div class="goalNumbers">
                                    <div class="goalNumbers__wrap">
                                        ...
                                        <div class="goalNumbers__item">
                                            @if($data_004['goal_coordinate_analysis_guest'][$i] ?? null)
                                                @foreach($data_004['goal_coordinate_analysis_guest'][$i] as $key => $value)
                                                <p class="coordinate" style="top: {{$value['coord_y']}}%;left: {{$value['coord_x']}}%;transform: translate(-50%, -60%)"><img src="/assets/img/svg/ic_cross.svg" alt=""></p>
                                                @endforeach
                                            @endif
                                        </div>
                ...
                <div class="infoBox">
                    ...
                    <p class="infoTeam">
                        <span class="teamColor home">
                            <svg class="icon" style="fill:{{$data_004['color_team_guest']}}!important">
                                <use xlink:href="/assets/img/svg/symbol-defs.svg#color-teams" />
                            </svg>
                        </span>
                        <span class="name">{{$data_004['team_guest_name']}}</span>
                    </p>
                ...
                <div class="graphCompareBox">
                    <div class="chartCompare2">
                        <div class="graph">
                            ...
                            <div class="item">
                                <span class="bar" style="width: calc({{$value}} * 22px); background-color: {{$data_004['color_team_guest']}};color: {{$data_004['color_team_guest']}}"><em class="num">{{$value}}</em></span>
                            </div>
                            @endforeach
                        </div>
                    </div>
