@extends('web.layouts.default2', ['title' => 'サッカープラス - Soccer-Plus -'], ['pageName' => 'fullPage'])
@section('content')
    ...
    <section class="movieIntro">
        <div class="movieAvatar">
            ...
            <div id="jsMovie" class="movieIframe">
                <iframe id="jsMovieIframe" frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="【確認用】リラックスヨガ" width="640" height="360" src="https://www.youtube.com/embed/gth-e3vY9WU?enablejsapi=1&amp;origin=http%3A%2F%2Ftc.tsite.jp.preview.cba&amp;widgetid=1"></iframe>
            </div>
        </div>
                ...
                <div class="postContentRow">
                    ...
                    <div class="detail">
                        <p class="txtCm01 lHeight2">サッカーにおけるデータ分析は、サッカービジネスの最前線であるヨーロッパで始まりました。<br>
                            ...
                            デジタルスコアブックでは、直感的で軽快な入力方法により集計したスタッツの分析や、確立等の詳細なデータの確認可能なため、コーチングやティーチングに加え、試合終了と同時に選手の振り返りにも活用することができます。</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="post mb0">
                <div class="postContent style01">
                    <div class="postContentRow">
                        ...
                        <div class="detail">
                            <p class="txtCm01 lHeight2">デジタルスコアブック「Soccer Pad2」は、<br>
                                タッチパネル式の入力方法により、シュート数やゴール数だけの簡易的な集計ではなく、<br>
                                ...
                                蓄積されたスタッツはチームアカウント内で保持されますので、<br>
            ...
            <div class="post mb0">
                <div class="postContent style04">
                    <div class="postContentRow">
                        ...
                        <div class="boxContact postThumbnail">
                            <p class="ttl">オンラインガイダンス<span class="sub">iPadセットモデル「Soccer-Plus」</span></p>
                            <div class="contact">
    ...
    <div class="inner02">
        <div class="inquiryBlock">
            ...
            <div class="boxContact">
                ...
                <div class="contact">
                    <a href="tel:0120945432" class="phone">03-1234-5678</a>
                    <p class="receptionHour">
                        電話予約 受付時間 /
                        <span class="time">10:00 ~ 18:00</span>
                    </p>
