...
/*===================================== AWS S3 =======================================*/
// https://ckeditor.com/docs/ckfinder/ckfinder3-php/configuration.html#configuration_options_backends_amazons3
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'files',
    'maxSize'           => '200M',
    'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,3gp,vob,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'images',
    'maxSize'           => '5M',
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,pdf,doc,docx',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
